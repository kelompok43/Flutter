...
class KelasCycling extends StatefulWidget {
  const KelasCycling({Key? key}) : super(key: key);

  @override
  State<KelasCycling> createState() => _KelasCyclingState();
}

class _KelasCyclingState extends State<KelasCycling>
