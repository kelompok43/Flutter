import 'package:fitness_gym/screens/kelas/kelas_cardio_screen.dart';
import 'package:fitness_gym/screens/kelas/kelas_cycling_screen.dart';
import 'package:fitness_gym/screens/kelas/kelas_mindbody_screen.dart';
...
import 'kelas_strength_screen.dart';
            ...
            child: Column(
              ...
              children: [
                  ...
                  children: [
                    ...
                    GestureDetector(
                      onTap: () => Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => const KelasMindBody())),
                      child: Container(
                        height: 100,
                        width: MediaQuery.of(context).size.width * 0.45,
                        decoration: const BoxDecoration(
                ...
                Row(
                  ...
                  children: [
                    GestureDetector(
                      onTap: ()=>Navigator.push(context,MaterialPageRoute(builder: (context)=>const KelasStrength())),
                      child: Container(
                        height: 100,
                        width: MediaQuery.of(context).size.width * 0.45,
                        decoration: const BoxDecoration(
                    ...
                    GestureDetector(
                      onTap: () => Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => const KelasCardio(),
                          )),
                      child: Container(
                        height: 100,
                        width: MediaQuery.of(context).size.width * 0.45,
