...
class KelasStrength extends StatefulWidget {
  const KelasStrength({Key? key}) : super(key: key);

  @override
  State<KelasStrength> createState() => _KelasStrengthState();
}

class _KelasStrengthState extends State<KelasStrength>
  ...
  Widget build(BuildContext context) {
    const String assetImage = "assets/img/strength_n_conditions.png";
