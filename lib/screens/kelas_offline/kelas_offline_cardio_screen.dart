...
class KelasOfflineCardio extends StatefulWidget {
  const KelasOfflineCardio({Key? key}) : super(key: key);

  @override
  State<KelasOfflineCardio> createState() => _KelasOfflineCardioState();
}

class _KelasOfflineCardioState extends State<KelasOfflineCardio>
  ...
  Widget build(BuildContext context) {
    const String assetImage = "assets/img/cardio.png";
