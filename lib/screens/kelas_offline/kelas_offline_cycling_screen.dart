...
class KelasOfflineCycling extends StatefulWidget {
  const KelasOfflineCycling({Key? key}) : super(key: key);

  @override
  State<KelasOfflineCycling> createState() => _KelasOfflineCyclingState();
}

class _KelasOfflineCyclingState extends State<KelasOfflineCycling>
