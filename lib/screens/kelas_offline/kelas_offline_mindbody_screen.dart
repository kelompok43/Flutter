...
class KelasOfflineMindBody extends StatefulWidget {
  const KelasOfflineMindBody({Key? key}) : super(key: key);

  @override
  State<KelasOfflineMindBody> createState() => _KelasOfflineMindBodyState();
}

class _KelasOfflineMindBodyState extends State<KelasOfflineMindBody>
