...
class KelasOfflineStrength extends StatefulWidget {
  const KelasOfflineStrength({Key? key}) : super(key: key);

  @override
  State<KelasOfflineStrength> createState() => _KelasOfflineStrengthState();
}

class _KelasOfflineStrengthState extends State<KelasOfflineStrength>
  ...
  Widget build(BuildContext context) {
    const String assetImage = "assets/img/strenth_n_conditions.png";
